          ...
          <div class="row">
            <div class="col-md-8 offset-md-2 col-sm-12">
              <div class="blog-snf-title">
                <a href="#" class="text-16">{{ selected_blog_category.name }}</a>
                ...
                <div class="blog-author-date d-flex align-items-center">
                  <div class="blog-snf-author d-flex align-items-center">
                    <div class="blog-snf-author-img">
                      <img :src=" $page.props.base.url + '/public/uploads/thumbnails/users/' + writer_info.thumbnail" alt="author">
                    </div>
                    <h4 class="text-16">{{ writer_info.name }}</h4>
                  </div>
                  ...
                  <div class="blog-snf-time d-flex align-items-center">
                    ...
                    <h4 class="text-16">{{ blog_details.read_time }} Min read</h4>
                  </div>
                </div>
              </div>
            </div>
