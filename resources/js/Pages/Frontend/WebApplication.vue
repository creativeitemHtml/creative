...
const props = defineProps({
    products: Array, // Receive users from the controller
    ...
    <div class="container">
      <div class="row justify-content-center padding-bottom-110">
        ...
        <div class="col-lg-4 col-md-6" v-for="product in products" :key="product.id">
          <a :href="product.purchase_url" target="_blank" class="single-application-link">
            <div class="single-application">
              <div class="application-baner">
                <img :src=" $page.props.base.url + '/public/uploads/thumbnails/products/' + product.thumbnail" alt="product">
              </div>
