...
const licenses = ['Free', 'Paid'];
const selectedLicense = ref(props.selected_license);

const updateSelectedLicense = (value) => {
...
const submitFilterForm = () => {
  form.get(route('search_element_products', { slug: props.selected_category }));
};
        ...
        <div class="row justify-content-between align-items-center">
            ...
            <div class="breadcrumb-three-content">
              <div class="content">
                <ul class="breadcrumb-slug">
                  <li class="items"><a href="#">Creative Elements</a></li>
          ...
          <div class="col-lg-3 col-md-3 d-none d-md-block">
            <div class="breadcrumb-three-img">
              <img v-if="selected_category_details.slug == 'ui-kits'" :src=" $page.props.base.url + '/public/assets/img/webp/graphics.png'" alt="" />
              <img v-else-if="selected_category_details.slug == 'components'" :src=" $page.props.base.url + '/public/assets/img/webp/components.webp'" alt="" />
              <img v-else-if="selected_category_details.slug == 'html'" :src=" $page.props.base.url + '/public/assets/img/webp/coding.webp'" alt="" />
              <img v-else-if="selected_category_details.slug == 'video'" :src=" $page.props.base.url + '/public/assets/img/webp/video-player.webp'" alt="" />
              <img v-else-if="selected_category_details.slug == '3d'" :src=" $page.props.base.url + '/public/assets/img/webp/3d-cube.webp'" alt="" />
              <img v-else-if="selected_category_details.slug == 'graphics'" :src=" $page.props.base.url + '/public/assets/img/webp/web-graphics.webp'" alt="" />
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="row">
              ...
              <div class="elementsUI-sidebar">
                ...
                <div class="filter-items">
                  <div class="filter-item">
                    ...
                    <div class="d-flex justify-content-between align-items-center pb-25">
                      <div class="icon-title">
                        <img :src=" $page.props.base.url + '/public/assets/img/icon/dashboard-2.svg'" alt="" />
                    ...
                    <ul class="link-filter-list">
                        <li v-for="category in element_categories" :key="category.id">
                            <Link :href="route('search_element_products', { slug: category.slug})" :class="{'active': selected_category === category.slug}">
                  ...
                  <div class="filter-item">
                    <!-- Title -->
                    <div
                      class="d-flex justify-content-between align-items-center pb-25"
                    >
                      <div class="icon-title">
                        <img :src=" $page.props.base.url + '/public/assets/img/icon/dashboard-2.svg'" alt="" />
                      ...
                      <li v-for="(license, key) in licenses" :key="key">
                        <div class="form-check filterCheck">
                          <input
                            ...
                            @change="updateSelectedLicense(license.toLowerCase())"
                            :checked="license.toLowerCase() === selectedLicense"
                          />
                  ...
                  <div v-if="selected_category_details.slug == 'components'" class="filter-item filter-item-scroll filter-item-last">
                    <!-- Title -->
                    <div class="d-flex justify-content-between align-items-center pb-25">
                      <div class="icon-title">
                        <img :src=" $page.props.base.url + '/public/assets/img/icon/dashboard-2.svg'" alt="" />
                    ...
                    <ul class="link-filter-list">
                      <li v-for="tag in tags" :key="tag.id">
                        <Link :href="route('search_element_products_by_tag', { slug: 'components', 'tag': tag.slug})" :class="{'active': selected_tag === tag.slug}">
                          <span>{{ tag.name }}</span>
                          <span>{{ tag.total_product }}</span>
                        </Link>
                      </li>
                    </ul>
                  </div>
          ...
          <div class="col-lg-9 col-md-8 col-sm-6">
            <div class="elementsUI-content">
              <!-- Products -->
              <div class="row">
                <div class="col-lg-4 col-md-6" v-for="element_product in element_products" :key="element_product.id">
                  <div v-if="element_product.element_category_id !== 2" class="product-item-three product-item-add">
                    <Link :href="generateProductDetailsLink(element_product.title, element_product.id)" class="product-three-link"></Link>
                    <div class="thumbnil-price">
                      <img :src="element_product.thumbnail" alt="" />
                      <ul class="wishlist-bookmark">
                        <li data-bs-toggle="tooltip" data-bs-placement="left" data-bs-title="Like">
                          <span :class="{ active: element_product.isActive }" @click="toggleActive(element_product)" href="#">
                    ...
                    <div class="content d-flex">
                      ...
                      <span class="product-price">${{ element_product.price }}</span>
                    </div>
                  </div>

                  <div v-else class="single-element-3">
                    <Link :href="generateProductDetailsLink(element_product.title, element_product.id)" class="element-card-link"></Link>
                    <img :src="element_product.thumbnail" alt="">
                    <p v-if="element_product.price_type === 'paid'" class="card-free">
                      ${{ element_product.price }}
                    </p>
                    ...
                    <div class="card-overlay">
                      <div class="overlay-copy-see d-flex align-items-center justify-content-between">
                        <span></span>
                        <Link :href="generateProductDetailsLink(element_product.title, element_product.id)" type="button" class="overlay-see" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Tooltip Title">
