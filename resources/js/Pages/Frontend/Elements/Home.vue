...
const fetchData = async (slug) => {
  try {
    const response = await fetch(`${page.props.base.url}/api/category_wise_elements/${slug}`);
...
const toggleActive = (element_product) => {
  handleLike(element_product)
};

const handleLike = async (element_product) => {
  const product_id = element_product.id;
  
  const url = `${page.props.base.url}/handleLike/${product_id}`;
...
<template>
    ...
    <section>
      <div class="container">
            ...
            <div class="elements-3-title-wrap">
                    ...
                    <div class="select-dropdown">
                      <ul>
                        ...
                        <li class="select-item">
                          ...
                          <span class="select-title">3D</span>
                        </li>
                        <li class="select-item">
                          <span id="select-icon">
                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                          ...
                          <span class="select-title">Graphics</span>
                        </li>
                      </ul>
                    </div>
                  </div>
                  <div class="element-3-search">
                    <input type="search" class="form-control" name="search" id="search" v-model="form.search" placeholder="Search all elements..." />
                    <button type="submit"><img :src=" $page.props.base.url + '/public/assets/img/new-icons-images/gray-search.svg'" alt=""></button>
                  </div>
                </div>
              </form>
              <!-- Tabs -->
              <div class="element-filter-tabs">
                <ul class="nav nav-pills" id="pills-tab" role="tablist">
                    <li v-for="element_category in element_categories" :key="element_category.id" class="nav-item" role="presentation">
                      <button class="nav-link" :class="{ active: element_category.slug === 'ui-kits' }" :id="'pills-' + element_category.slug + '-tab'" data-bs-toggle="pill" :data-bs-target="'#pills-' + element_category.slug" type="button" role="tab" :aria-controls="'pills-' + element_category.slug" aria-selected="false" @click="fetchData(element_category.slug)">
                        <img :src="$page.props.base.url + '/public/assets/img/new-icons-images/blue-search.svg'" alt="">
        ...
        <div class="tab-content element-tab-content" id="pills-tabContent">
          <!-- UI Kits Content -->
          <div v-for="element_category in element_categories" :key="element_category.id" class="tab-pane fade" :class="{ 'show active': element_category.slug === 'ui-kits' }" :id="'pills-' + element_category.slug" role="tabpanel" :aria-labelledby="'pills-' + element_category.slug + '-tab'" tabindex="0">
            <div class="row justify-content-center">
              <!-- Single Element -->
              <div class="col-lg-3 col-md-4 col-sm-6" v-for="element in elements" :key="element.id">

                <div v-if="element.element_category_id !== 2" class="product-item-three product-item-add">
                  <Link :href="generateProductDetailsLink(element.title, element.id)" class="product-three-link"></Link>
                  <div class="thumbnil-price">
                    ...
                    <ul class="wishlist-bookmark">
                      <li data-bs-toggle="tooltip" data-bs-placement="left" data-bs-title="Like">
                        <span :class="{ active: element.isActive }" @click="toggleActive(element)" href="#">
                ...
                <div v-else class="single-element-3">
                  <Link :href="generateProductDetailsLink(element.title, element.id)" class="element-card-link"></Link>
                  <img :src="element.thumbnail" alt="">
                  <p v-if="element.price_type === 'paid'" class="card-free">
                    ${{ element.price }}
                  </p>
                  <p v-else class="card-free">
                    Free
                  </p>
                  <div class="card-overlay">
                    <div class="overlay-copy-see d-flex align-items-center justify-content-between">
                      <span></span>
                      <Link :href="generateProductDetailsLink(element.title, element.id)" type="button" class="overlay-see" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Tooltip Title">
              ...
              <div class="col-md-12">
                <div class="element-more-btn-wrap d-flex justify-content-center">
                  <a href="#" class="element-more-btn d-flex align-items-center">See More<i class="fa-solid fa-long-arrow-right"></i></a>
                </div>
              </div>
            </div>
          </div>
    ...
    <section class="pb-110">
      <div class="container">
        ...
        <div class="el-title-three text-center pb-50">
            <h4 class="title">Transform your ideas into masterpieces <span>with Creative Elements</span></h4>
            <p class="info">Unleash your potential with our products for crafting digital excellence and making your imagination into reality.</p>
        </div>
        <div class="row flex-column-reverse flex-lg-row align-items-center">
            ...
            <ul class="choice-one-items">
                <li>
                  <div class="choice-item">
                      <div class="icon"><img :src=" $page.props.base.url + '/public/assets/img/webp/high-quality.webp'" alt=""></div>
                      <div class="content">
                          <h3 class="title">High-quality UI Resources</h3>
                          <p class="info">Access a wide variety of innovative UI elements for effortless design improvement.</p>
                      </div>
                  </div>
                </li>
                <li>
                  <div class="choice-item">
                      <div class="icon"><img :src=" $page.props.base.url + '/public/assets/img/webp/checkmark.webp'" alt=""></div>
                      <div class="content">
                          <h3 class="title">Following Design Trend</h3>
                          <p class="info">Stay ahead of the curve and meet the demands with our trend-savvy UI components.</p>
                      </div>
                  </div>
                </li>
                <li>
                  <div class="choice-item">
                      <div class="icon"><img :src=" $page.props.base.url + '/public/assets/img/webp/searching-done.webp'" alt=""></div>
                      <div class="content">
                          <h3 class="title">New Design Release Every Week</h3>
                          <p class="info">Every week, we provide new, improved designs to keep you on the cutting edge.</p>
                      </div>
                  </div>
                </li>
                <li>
                  <div class="choice-item">
                      <div class="icon"><img :src=" $page.props.base.url + '/public/assets/img/webp/digital-content.webp'" alt=""></div>
                      <div class="content">
                          <h3 class="title">Ready For Customization</h3>
                          <p class="info">Our developers customize solutions to meet your unique needs because your requirements are our top priority.</p>
                      </div>
                  </div>
                </li>
            </ul>
          ...
          <div class="col-lg-6">
            <div class="img-fluid"><img :src=" $page.props.base.url + '/public/assets/img/webp/banner-image-4.webp'" alt=""></div>
          </div>
        </div>
      </div>
    </section>
        ...
        <div class="row justify-content-center">
          <div class="col-md-12">
            <div class="pricing-n-title">
              <h1 class="text-52">Explore Our Competitive Pricing Model</h1>
            ...
            <div class="single-n-pricing" :class="{ active: pack.name === 'Pro' }">
              ...
              <div class="pricing-n-price d-flex">
                ...
                <h3 class="pricing-price-r d-flex">
                  <span v-if="pack.discounted_price != 0">$</span><span>{{ pack.price }}</span>
                  <span>/ {{ pack.int_val }}</span></h3>
              </div>
              <p class="text-15 pricing-n-batch">{{ pack.interval_period_text }}</p>
              <div class="pricing-n-list">
                <ul>
                  <li v-for="packages_feature in pack.packages_features" :key="packages_feature.id">{{ packages_feature }}</li>
                </ul>
              </div>
    ...
    <!-- Start Trending Categories -->
    <section class="el-treading pb-60">
        <div class="container">
            <h4 class="el-title-two text-center pb-40">Browse Trending <span>Categories</span></h4>
            <div class="row justify-content-center">
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <Link :href="route('search_element_products', { slug: 'ui-kits'})" class="trending-item-one" style="--bg: linear-gradient(135deg, rgba(255, 233, 239, 1) 0%, rgba(246, 229, 252, 1) 100%)">
                        <div class="img"><img :src=" $page.props.base.url + '/public/assets/img/webp/graphics.png'" alt="" /></div>
                        <p class="title">Web UI</p>
                    </Link>
                </div>
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <Link :href="route('search_element_products', { slug: 'components'})" class="trending-item-one" style="--bg: linear-gradient(135deg, rgba(242, 252, 255, 1) 0%, rgba(213, 235, 255, 1) 100%)">
                        <div class="img"><img :src=" $page.props.base.url + '/public/assets/img/webp/components.webp'" alt="" /></div>
                        <p class="title">Components</p>
                    </Link>
                </div>
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <Link :href="route('search_element_products', { slug: 'html'})" class="trending-item-one" style="--bg: linear-gradient(135deg, rgba(239, 253, 250, 1) 0%, rgba(224, 250, 241, 1) 100%)">
                        <div class="img"><img :src=" $page.props.base.url + '/public/assets/img/webp/coding.webp'" alt="" /></div>
                        <p class="title">HTML</p>
                    </Link>
                </div>
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <Link :href="route('search_element_products', { slug: 'video'})" class="trending-item-one" style="--bg: linear-gradient(135deg, rgba(252, 250, 239, 1) 0%, rgba(247, 235, 211, 1) 100%)">
                        <div class="img"><img :src=" $page.props.base.url + '/public/assets/img/webp/video-player.webp'" alt="" /></div>
                        <p class="title">Video</p>
                    </Link>
                </div>
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <Link :href="route('search_element_products', { slug: '3d'})" class="trending-item-one" style="--bg: linear-gradient(135deg, rgba(244, 235, 254, 1) 0%, rgba(248, 233, 255, 1) 100%)">
                        <div class="img"><img :src=" $page.props.base.url + '/public/assets/img/webp/3d-cube.webp'" alt="" /></div>
                        <p class="title">3D</p>
                    </Link>
                </div>
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <Link :href="route('search_element_products', { slug: 'graphics'})" class="trending-item-one" style="--bg: linear-gradient(135deg, rgba(228, 250, 255, 1) 0%, rgba(217, 244, 253, 1) 100%)">
                        <div class="img"><img :src=" $page.props.base.url + '/public/assets/img/webp/web-graphics.webp'" alt="" /></div>
        ...
        <div class="row justify-content-center">
          <div class="col-lg-6">
            <div class="text-center pb-60">
              <h3 class="fz-34-sb-black pb-15">Faqs</h3>
    ...
    <section class="pb-110">
      <div class="container">
          ...
          <div class="row justify-content-center">
              <div class="col-lg-6">
                  <div class="text-center pb-60">
                      <h3 class="fz-34-sb-black pb-15">What Clients Says</h3>
                      <p class="fz-16-m-black-2">Our satisfied clients shared some precious words about their creative journey with us.</p>
                  </div>
              </div>
          </div>
          <!-- Items -->
          <div class="row">
              <div class="col-lg-6">
                  <div class="el-review-one-item">
                      <div class="img"><img :src=" $page.props.base.url + '/public/assets/img/user-review-1.webp'" alt=""></div>
                      <div class="content">
                          <ul class="rating">
                              <li><img :src=" $page.props.base.url + '/public/assets/img/icon/star.svg'" alt=""></li>
                              <li><img :src=" $page.props.base.url + '/public/assets/img/icon/star.svg'" alt=""></li>
                              <li><img :src=" $page.props.base.url + '/public/assets/img/icon/star.svg'" alt=""></li>
                              <li><img :src=" $page.props.base.url + '/public/assets/img/icon/star.svg'" alt=""></li>
                              <li><img :src=" $page.props.base.url + '/public/assets/img/icon/star.svg'" alt=""></li>
                          </ul>
                          <p class="info">My experience with Creative Elements has been fantastic. The support service is responsive, and the templates are excellent. I've been able to design beautiful websites for my clients, and they are always pleased with the results.</p>
              ...
              <div class="col-lg-6">
                  <div class="el-review-one-item">
                      <div class="img"><img :src=" $page.props.base.url + '/public/assets/img/user-review-2.webp'" alt=""></div>
                      <div class="content">
                          <ul class="rating">
                              <li><img :src=" $page.props.base.url + '/public/assets/img/icon/star.svg'" alt=""></li>
                              <li><img :src=" $page.props.base.url + '/public/assets/img/icon/star.svg'" alt=""></li>
                          ...
                          <p class="info">I have nothing but praise for Creative Elements. My projects remain current and fresh thanks to their design releases. For my web design business, it has been a game-changer, and I heartily endorse it to other professionals.</p>
                          <div class="d-flex align-items-end g-10">
          ...
          <div class="d-flex justify-content-center">
              <a href="#" class="el-review-all">Check all reviews</a>
          </div>
      </div>
    </section>
    <!-- End Review Area -->
          ...
          <div class="row justify-content-center">
              <div class="col-lg-6">
                  <div class="text-center pb-50">
                      <h3 class="fz-34-sb-black pb-15">Explore Our Latest Blogs</h3>
                      <p class="fz-16-m-black-2">Learn more about Creative Elements and inspire your creativity from our latest posts.</p>
                  </div>
              </div>
          </div>
          <!-- Items -->
          <div class="row justify-content-center">
            <div class="col-lg-4 col-md-6" v-for="latest_blog in latest_blogs" :key="latest_blog.id">
              <Link :href="route('blog_details', { slug: latest_blog.slug})" class="el-blog-item-one">
                <div class="img"><img :src=" $page.props.base.url + '/public/uploads/blog/thumbnail_image/' + latest_blog.thumbnail" alt=""></div>
                <div class="content">
                  <ul class="topic-date">
                    <li class="item">{{ latest_blog.blog_category_name }}</li>
                    <li class="item">{{ formatDate(latest_blog.created_at) }}</li>
                  </ul>
                  <p class="title">{{ latest_blog.title }}</p>
                </div>
              </Link>
            </div>
            </div>
          <div class="d-flex justify-content-center">
              <Link :href="route('blog')" class="el-review-all">Check all blogs</Link>
          </div>
      </div>
    </section>
    <!-- End Blog Area -->
    ...
    <section class="el-ask-wrap-one pb-110">
      <div class="container">
          <div class="el-ask-one">
              <div class="img"><img :src=" $page.props.base.url + '/public/assets/img/webp/ask-qus-one.webp'" alt=""></div>
              <div class="content">
                  <h3 class="title">Any questions you can ask us</h3>
                  <p class="info">If you have any more queries, don't hesitate to ask us anything - We're here to help you throughout your journey with us!</p>
