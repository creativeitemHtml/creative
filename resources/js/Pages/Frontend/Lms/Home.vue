              ...
              <div class="lms-video-details">
                ...
                <div class="creator-website d-flex align-items-center">
                  <div class="creator-profile d-flex align-items-center">
                    <img :src=" $page.props.base.url + '/public/assets/img/new-icons-images/creator-1.svg'" alt="creator">
                    <img :src=" $page.props.base.url + '/public/assets/img/new-icons-images/creator-2.svg'" alt="creator">
                    <img :src=" $page.props.base.url + '/public/assets/img/new-icons-images/creator-3.svg'" alt="creator">
                  </div>
                  <p>150,000+ creators have their websites live</p>
                </div>
              </div>
              <!-- Right -->
              <div class="lms-video-wrap">
                <div class="lms-video-inner">
                  <div class="plyr__video-embed my-lms-video-player" id="player-5">
                ...
                <div class="video-after-1">
                  <img :src=" $page.props.base.url + '/public/assets/img/new-icons-images/video-after-1.svg'" alt="shap">
                </div>
                <div class="video-after-2">
                  <img :src=" $page.props.base.url + '/public/assets/img/new-icons-images/video-after-2.svg'" alt="shap">
                </div>
                <div class="video-after-3">
                  <img :src=" $page.props.base.url + '/public/assets/img/new-icons-images/video-after-3.svg'" alt="shap">
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="row mcg-30 mrg-30 justify-content-center">
            ...
            <div class="problem-solve-card">
              <div class="solve-img-wrap">
                <div class="solve-card-img">
                  <img :src=" $page.props.base.url + '/public/assets/img/new-icons-images/problem-solve-1.svg'" alt="">
                </div>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="problem-solve-card">
              <div class="solve-img-wrap">
                <div class="solve-card-img">
                  <img :src=" $page.props.base.url + '/public/assets/img/new-icons-images/problem-solve-2.svg'" alt="">
                </div>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="problem-solve-card">
              <div class="solve-img-wrap">
                <div class="solve-card-img">
                  <img :src=" $page.props.base.url + '/public/assets/img/new-icons-images/problem-solve-3.svg'" alt="">
                </div>
          ...
          <div class="col-md-12">
            <div class="problem-solve-learn">
              ...
              <a href="#" class="learn-btn">Learn More <img :src=" $page.props.base.url + '/public/assets/img/new-icons-images/right-arrow-white.svg'" alt=""></a>
            </div>
          </div>
        </div>
      </div>
              ...
              <div class="success-counter-wrap d-flex">
                ...
                <div class="single-success-wrap">
                  <div class="single-success-item">
                    <p>Learners</p>
                    <h2 class="text-46"><span class="counter">10</span>M+</h2>
                  </div>
                </div>
                <!-- Single -->
                <div class="single-success-wrap">
                  <div class="single-success-item">
                    <p>Top Courses</p>
                    <h2 class="text-46"><span class="counter">150</span>+</h2>
                  </div>
                </div>
                <!-- Single -->
                <div class="single-success-wrap">
                  <div class="single-success-item">
                    <p>Best Award</p>
                    <h2 class="text-46"><span class="counter">45</span>+</h2>
                  </div>
                </div>
                <!-- Single -->
                <div class="single-success-wrap">
                  <div class="single-success-item">
                    <p>Online Courses</p>
                    <h2 class="text-46"><span class="counter">5</span>k+</h2>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="col-lg-6 col-md-8">
            <div class="how-to-banner-area d-flex justify-content-start">
              <div class="how-to-banner">
                <img :src=" $page.props.base.url + '/public/assets/img/new-icons-images/how-to-banner.webp'" alt="banner">
                <!-- Item 1 -->
                <div class="how-to-banner-item-1 d-flex align-items-center">
                  <div class="banner-win-img">
                    <img :src=" $page.props.base.url + '/public/assets/img/new-icons-images/win-cup.svg'" alt="cup">
                  </div>
                ...
                <div class="how-to-banner-item-2">
                  ...
                  <div class="banner-item-profiles d-flex align-items-center justify-content-center">
                    ...
                    <img :src=" $page.props.base.url + '/public/assets/img/new-icons-images/creator-2.svg'" alt="creator">
                    <img :src=" $page.props.base.url + '/public/assets/img/new-icons-images/creator-3.svg'" alt="creator">
                    <img :src=" $page.props.base.url + '/public/assets/img/new-icons-images/creator-4.svg'" alt="creator">
            ...
            <div class="how-to-details">
              ...
              <div class="success-signup-form">
                <form action="">
                  ...
                  <button type="submit">Free Sign up <img :src=" $page.props.base.url + '/public/assets/img/new-icons-images/right-angle.svg'" alt=""></button>
                </form>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-12">
            <div class="lms-new-topic">
              <div class="new-advice-topic">
                <img :src=" $page.props.base.url + '/public/assets/img/new-icons-images/topic-9.svg'" alt="">
                <p>Subscription Based Pricing Plans</p>
              </div>
              <div class="new-advice-topic">
                <img :src=" $page.props.base.url + '/public/assets/img/new-icons-images/topic-10.svg'" alt="">
                <p>AI Powered</p>
              </div>
              <div class="new-advice-topic">
                <img :src=" $page.props.base.url + '/public/assets/img/new-icons-images/topic-11.svg'" alt="">
                <p>Cloud Based LMS</p>
              </div>
              <div class="new-advice-topic">
                <img :src=" $page.props.base.url + '/public/assets/img/new-icons-images/topic-12.svg'" alt="">
                <p>Free Access to the ocean of content library</p>
              </div>
              <div class="new-advice-topic">
                <img :src=" $page.props.base.url + '/public/assets/img/new-icons-images/topic-13.svg'" alt="">
                <p>Online Certification</p>
              </div>
              <div class="new-advice-topic">
                <img :src=" $page.props.base.url + '/public/assets/img/new-icons-images/topic-14.svg'" alt="">
                <p>Continuous Update</p>
              </div>
              <div class="new-advice-topic">
                <img :src=" $page.props.base.url + '/public/assets/img/new-icons-images/topic-15.svg'" alt="">
                <p>Free for small users - Forever</p>
              </div>
              <div class="new-advice-topic">
                <img :src=" $page.props.base.url + '/public/assets/img/new-icons-images/topic-16.svg'" alt="">
                <p>All in one LMS</p>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-12">
            <div class="lms-difference-wrap">
              <div class="lms-difference-single d-flex align-items-center">
                ...
                <div class="img"><img :src=" $page.props.base.url + '/public/assets/img/lms/difference-1.webp'" alt="icon"></div>
                <p class="info info-right">Recurring Payments</p>
              </div>
              <div class="lms-difference-single d-flex align-items-center">
                <p class="info info-left">Fixed Features</p>
                <div class="img"><img :src=" $page.props.base.url + '/public/assets/img/lms/difference-2.webp'" alt="icon"></div>
                <p class="info info-right">Scalable Features</p>
              </div>
              <div class="lms-difference-single d-flex align-items-center">
                <p class="info info-left">Self-hosting</p>
                <div class="img"><img :src=" $page.props.base.url + '/public/assets/img/lms/difference-3.webp'" alt="icon"></div>
                <p class="info info-right">Cloud-Based</p>
              </div>
              <div class="lms-difference-single d-flex align-items-center">
                <p class="info info-left">Upfront Installation</p>
                <div class="img"><img :src=" $page.props.base.url + '/public/assets/img/lms/difference-4.webp'" alt="icon"></div>
                <p class="info info-right">Easy Setup</p>
              </div>
              <div class="lms-difference-single d-flex align-items-center">
                <p class="info info-left">Customization</p>
                <div class="img"><img :src=" $page.props.base.url + '/public/assets/img/lms/difference-5.webp'" alt="icon"></div>
                <p class="info info-right">Standardized Features</p>
              </div>
              <div class="lms-difference-single d-flex align-items-center">
                <p class="info info-left">Limited Support</p>
                <div class="img"><img :src=" $page.props.base.url + '/public/assets/img/lms/difference-6.webp'" alt="icon"></div>
                <p class="info info-right">Full Support</p>
              </div>
              <div class="lms-difference-single d-flex align-items-center">
                <p class="info info-left">Licensing Fees</p>
                <div class="img"><img :src=" $page.props.base.url + '/public/assets/img/lms/difference-7.webp'" alt="icon"></div>
                <p class="info info-right">Predictable Costs</p>
              </div>
              <div class="lms-difference-single d-flex align-items-center">
                <p class="info info-left">High Upfront Cost</p>
                <div class="img"><img :src=" $page.props.base.url + '/public/assets/img/lms/difference-8.webp'" alt="icon"></div>
                <p class="info info-right">Low Upfront Cost</p>
              </div>
              <div class="lms-difference-single d-flex align-items-center">
                <p class="info info-left">Paid Latest Version</p>
                <div class="img"><img :src=" $page.props.base.url + '/public/assets/img/lms/difference-9.webp'" alt="icon"></div>
                <p class="info info-right">Free Latest Version</p>
              </div>
              <div class="lms-difference-single d-flex align-items-center">
                <p class="info info-left">Paid Dedicated Expert Support</p>
                <div class="img"><img :src=" $page.props.base.url + '/public/assets/img/lms/difference-10.webp'" alt="icon"></div>
        ...
        <div class="row align-items-center padding-bottom-110">
          ...
          <div class="col-md-5 order-1 order-md-2">
            <div class="customer-support-banner">
              <img :src=" $page.props.base.url + '/public/assets/img/new-icons-images/customer-support-banner.svg'" alt="">
            </div>
          </div>
        </div>
      </div>
