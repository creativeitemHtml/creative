                            ...
                            <div class="invoice-items">
                                <div class="invoice-item">
                                    <div class="invoice-info">
                                        <h5 class="title">Bill to {{ invoice_details.payment_to_user.name}}</h5>
                                        <p class="info">
                                            {{ invoice_details.payment_to_user.email }}
                                        </p>
                                        <p class="info">
                                            {{ invoice_details.payment_to_user.phone }}
                                        </p>
                                    </div>
                                </div>
                                <div class="invoice-item">
                                ...
                                <div class="invoice-item">
                                    <div class="invoice-info">
                                        ...
                                        <p class="info">#{{ invoice_details.id }}</p>
                                    </div>
                                    <div class="invoice-info">
                                        <h5 class="title">Date</h5>
                                        <p class="info">{{ invoice_details.formattedDate }}</p>
                                    </div>
                                    <div class="invoice-info">
                                        <span class="paid">Paid - ${{ invoice_details.paid_amount }}</span>
                                    </div>
                                </div>
                            </div>
                            <!-- Table -->
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="dl_property_price">
                                                    <p>{{ invoice_details.formattedDate }}</p>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="dl_property_id">
                                                    <p>{{ invoice_details.payment_to_elementProduct.title }}</p>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="dl_property_price">
                                                    <p>${{ invoice_details.paid_amount }}</p>
                                                </div>
                                            </td>
                                        </tr>
                                    </tbody>
