                ...
                <div class="sidebar_customer_panel">
                    ...
                    <div class="l_sidebarMenu l_sidebarMenu-2">
                        <ul class="nav-links accordion-menu">
                            <li class="nav-links-li-2" :class="{ 'active-submenu': route().current('customer.dashboard') }">
                                <Link :href="route('customer.dashboard')" class="nav-item d-flex align-items-center">
                            ...
                            <li class="nav-links-li-2" :class="{ 'active-submenu': route().current('customer.subscription_details') || route().current('customer.purchase_history') || route().current('customer.wishlists') || route().current('customer.downloads') }">
                                ...
                                <ul class="sideBar-sub" :style="{ display: route().current('customer.subscription_details') || route().current('customer.purchase_history') || route().current('customer.wishlists') || route().current('customer.downloads') ? 'block' : 'none' }">
                            ...
                            <li class="nav-links-li-2" :class="{ 'active-submenu': route().current('customer.profile') }">
                                <Link :href="route('customer.profile')" class="nav-item d-flex align-items-center">
                                    <div class="sidebar_icon">
                                    <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
