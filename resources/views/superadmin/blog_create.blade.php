                ...
                <ul class="productPriceOption">
                    <li>
                        <div class="form-check">
                            <input class="form-check-input ciRadio ciRadio-OutlinePrimary" type="radio" name="visibility" id="visibility" />
                            <label class="form-check-label" for="visibility">{{ get_phrase('Make this blog public') }}</label>
                        </div>
                    </li>
                    <li>
                        <div class="form-check">
                            <input class="form-check-input ciRadio ciRadio-OutlinePrimary" type="radio" name="ability_to_comment" id="ability_to_comment" />
                            <label class="form-check-label" for="ability_to_comment">{{ get_phrase('People can leave their comment') }}</label>
                        </div>
                    </li>
                    <li>
                        <div class="form-check">
                            <input class="form-check-input ciRadio ciRadio-OutlinePrimary" type="radio" name="is_featured" id="is_featured" />
