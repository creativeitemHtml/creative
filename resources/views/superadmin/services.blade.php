<div class="admin_main_right p-30 bd-r-5">
    ...
    <div class="title-btn-menu-wrap d-flex justify-content-between align-items-center flex-wrap g-10 pb-30">
        ...
        <a href="javascript:;" class="new-project-btn new-project-btn-desktop" onclick="largeModal('{{ route('superadmin.service_create') }}', '{{ get_phrase('Create new service') }}')">{{ get_phrase('Create new service') }}</a>
    ...
    <div class="el-products-tab-wrap">
        <ul class="nav nav-pills pb-20" id="pills-tab" role="tablist">
            ...
            @php $service_details = App\Models\Service::where('product_id', $product->id)->get(); @endphp
