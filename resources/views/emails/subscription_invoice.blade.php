            ...
            <tbody>
                           ...
                           <div>
                                ...
                                <div class="feature-item" style="margin-top:30px; ">
                                     <div class="feature-text">
                                        <p style="color:#0C141D; font-size: 24px; font-weight:600">Your Subscription invoice</p>
                                     </div>
                ...
                <tr style="text-align: center;">
                    <td>
                        ...
                        <p style="font-size: 15px; color: #7B7F84; margin: 0; margin-top: 6px;">{{ $subscription_details->payment_method }}</p>
                    </td>
                </tr>
                <tr>
