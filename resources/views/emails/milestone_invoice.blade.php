...
<head>
    ...
    <title>Creativeitem.com | Milestone Payment </title>
            ...
            <tbody>
                           ...
                           <div>
                                ...
                                <div class="feature-item" style="margin-top:30px; ">
                                     <div class="feature-text">
                                        <p style="color:#0C141D; font-size: 24px; font-weight:600">Milestone Payment Invoice</p>
                                     </div>
                                     <div style="display: flex; justify-content: space-between; align-items: center;">
                                         <div>
                                            <p style="color: #0C141D; font-size: 16px;">Date: {{ date('d m, Y') }}</p>
                                            <p style="color: #0C141D; font-size: 16px;">Milestone ID: 2024-{{ $payment_details->id }}</p>
                                         </div>
                                     </div>
                                </div>
                           </div>
                    ...
                    <td>
                        <table style="border:1px solid #E4E7EC; margin-top: 15px;" cellpadding="20" cellspacing="0" width="600" id="emailContainer">
                            ...
                            <tr>
                                ...
                                <td style="text-align: center; padding:16px 0 ; border-bottom: 1px solid #E4E7EC;">
                                    <p style="margin: 0;  color: #0C141D; font-size: 15px;">{{ $payment_details->title }}</p>
                                </td>
                                <td style="text-align: center; padding: 16px 0 ; border-bottom: 1px solid #E4E7EC;">
                                    <p style="margin: 0; font-size: 15px; color: #0C141D;">${{ $payment_details->amount }}</p>
                                </td>
                                <td style="text-align: center; padding: 16px  0; border-bottom: 1px solid #E4E7EC;">
                                    <p style="margin: 0; font-size: 15px; color: #0C141D;">${{ $payment_details->amount }}</p>
                                </td>
                            ...
                            <tr>
                                ...
                                <td style="text-align: center; padding: 16px 0 ;"> </td>
                                <td style="text-align: center; padding: 16px 0 ;">
                                    <p style="margin: 0; font-size: 16px; font-weight: 500; color: #007BFF;">${{ $payment_details->amount }}</p>
                                </td>
                            </tr>
                        </table>
                    </td>
                ...
                <tr style="text-align: center;">
                    <td>
                        ...
                        <p style="font-size: 15px; color: #7B7F84; margin: 0; margin-top: 6px;">{{ $payment_details->payment_method }}</p>
                    </td>
                </tr>
                <tr>
